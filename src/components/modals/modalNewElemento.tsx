...
import NewElemento from '../forms/newElemento'

export default function ModalNewElemento() {
    const [modalNewElemento_loading, setModalNewElemento_loading] = useState(true)

    const { setOpenFormModal } = useModal()

    useEffect(() => {
        setModalNewElemento_loading(false)
    }, [])
